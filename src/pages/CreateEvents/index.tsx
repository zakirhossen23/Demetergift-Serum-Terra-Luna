...
import initialize_market from '@/psyoption/components/InitializeMarket/InitOptionMarket'
import {
    BuilderField,
    BuilderSubmitButton,
    BuilderTransaction,
...
export default function CreateEvents() {
    ...
    async function initializing_market() {

        const  optionPublicKey = new PublicKey(
            '5Wn8Njt7VsG8cUdY9A63Q7SoJXqv2NCr74EzHcZdbUD5'
          );
        console.log(optionPublicKey.toBytes());
    }
        ...
        <><>
            <Row>
                ...
                <Col >
                    <div style={{ width: "600px", background: "transparent", padding: "19px", borderRadius: "4px", height: "100%", border: "white solid" }}>
                        ...
                        <Button style={{ margin: "17px 0 0px 0px", width: "100%" }} onClick={initializing_market}>
                            Create Event
                        </Button>
                    </div>
                </Col>
            ...
            <Modal show={createCategoryModal}
                ...
                <Modal.Body className="show-grid">
                    <Form>
                        <div style={{ margin: "18px 0" }}>
                            <h4 style={{ marginBottom: "10px"}}>Category Title</h4>
                            <Form.Control
                        ...
                        <div style={{ margin: "18px 0" }}>
                            <h4 style={{ marginBottom: "10px" }}>Amount</h4>
                            <Form.Control
                        ...
                        <div style={{ margin: "18px 0" }}>
                            <h4 style={{ marginBottom: "10px" }}>Price of A Piece</h4>
                            <Form.Control
                        ...
                        <div style={{ margin: "18px 0" }}>
                            <h4 style={{ marginBottom: "10px" }}>Category Image Link</h4>
                            <Form.Control
